...
const Hero = () => {
  return (
    <div className="min-h-[50vh] sm:min-h-[60vh] md:min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100">
      <div className="container px-3 sm:px-4 py-6 sm:py-8 md:py-16 animate-fade-up">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-900 mb-3 sm:mb-4 md:mb-6">
